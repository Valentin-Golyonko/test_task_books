...
# Celery settings
CELERY_BROKER_URL = os.environ.get('C_BROKER')
CELERY_RESULT_BACKEND = os.environ.get('C_BACKEND')
...
SECRET_KEY = '874k!xbt@=+bsfg8y3a&5$*glqsmfa60ye45$zaa_2xdohl@19'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'books/static/books/'),
]
